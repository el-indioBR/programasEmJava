...
class Calcula_distancia_entre_pontos_no_espaco_usando_classe_versao_2 {
    public static void main(String args[]) {
        ...
        distancia = Math.sqrt(Math.pow((P2.x - P1.x), 2) + Math.pow((P2.y - P1.y), 2) + Math.pow((P2.z - P1.z), 2));
